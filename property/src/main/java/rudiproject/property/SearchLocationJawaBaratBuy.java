...
@Test
public class SearchLocationJawaBaratBuy {
	
	public void searchLocationBuy () throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name='search-bar']")).sendKeys(province);
